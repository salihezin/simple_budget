    ...
    return (
        <>
            ...
            <div style={{flexDirection: 'row', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between'}}>
                ...
                <Card title="Borç" subTitle="Kredi Kartım" header={header('credit_card')} style={{width: '20%', marginTop: 20}}/>
                <Card title="Borç" subTitle="Diğer Borçlarım" header={header('other_debt')} style={{width: '20%', marginTop: 20}}/>
            </div>
            <Divider align="right">
                <Button label="Şablondaki Kartları Ekle" icon="pi pi-thumbs-up" className="p-button-outlined"></Button>
            </Divider>
        </>
    )
}
